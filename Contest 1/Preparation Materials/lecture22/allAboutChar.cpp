//https://www.youtube.com/watch?v=Wdjr6uoZ0e0
...
bool isPalindrome1(char a[], int size) {
...
bool isPalindrome2(char a[], int size) {
    int s = 0;
    int e = size - 1;
    while( s < e ) {
        //non-case sensitive
...
char getMaxOccChar(string s) {
    ...
    for(int i=0; i<s.length(); i++) {
        ...
        number = ch - 'a';
        //??????
        // cout << "arr[number] " << number << " => " << arr[number] << endl;
